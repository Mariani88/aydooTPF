...
public class InformacionEstadistica {
	 ...
	 * @param id
	 * @param cantidad
	 * @throws BicicletaMasUsadaExcepcion
	 *             si cantidad no es un maximo
	 */
	...
	private boolean guardarMaximoBicicleta(int id, int cantidad) {
		Iterator<Entry<Integer, Integer>> iterador = this.bicicletasMasUsadas.entrySet().iterator();
	...
	/**
	 * guarda el id de la bicicleta menos usada y su cantidad de forma
	 * arbitraria.
	 * 
	 * @param id
	 * @param cantidad
	 * @throws BicicletaMenosUsadaExcepcion
	 *             si cantidad no es un minimo
	 */
	...
	private boolean guardarMinimoBicicleta(int id, int cantidad) {
		...
		Iterator<Entry<Integer, Integer>> iterador = this.bicicletasMenosUsadas.entrySet().iterator();
		Entry<Integer, Integer> primerPar = iterador.next();
	...
	private boolean guardarMaximoRecorrido(Ruta ruta, int cantidad) {
		...
		Iterator<Entry<Ruta, Integer>> iterador = this.recorridoMasRealizado.entrySet().iterator();
